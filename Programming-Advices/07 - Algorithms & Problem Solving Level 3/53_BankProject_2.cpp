...
void PerfromTransactionOption(enTransactionOptions TransactionOptions)
{
...
void ShowTransactionMenu()
{
    ...
    cout << "\t[4] MainMinu.\n";
    cout << "===========================================\n";
    PerfromTransactionOption((enTransactionOptions)ReadMainMenueOption());
}
