// Project#1_Solved_By_Eng.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void SetWinnerScreenColor(enWinner Winner) {
	switch (Winner) {
		...
		case enWinner::Computer:
			system("color 5F"); //turn screen to Red      
		cout << "\a"; 
		break;
		default:   
...
GameResults.WinnerName = WinnerName(GameResults.GameWinner); return GameResults;
...
{ 
	...
	cin >> GameRounds; } while (GameRounds < 1 || GameRounds >10); 
	return GameRounds; 
}
