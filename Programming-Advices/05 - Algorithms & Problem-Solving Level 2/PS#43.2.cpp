// PS#43.2.cpp : This file contains the 'main' function. Program execution begins and ends there.
...
int  CountEvenNumberArrayElements(int arr[100], int arrLength)
{
    int oddnumber = 0;
    for (int i = 0; i < arrLength; i++)
    {
        if (CheckOddNumber(arr[i]) == OddEvevn::Even)
        {
            oddnumber++;
        }
    }
...
int main() {
    ...
    cout << "\nCount of Odd number : " << CountEvenNumberArrayElements(arr, arrLength) << endl;
    return 0;
